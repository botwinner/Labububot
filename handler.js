...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '𝙏𝙞𝙡𝙞𝙣-𝘽𝙤𝙩' + gt + ' 𝗖𝗿𝗲𝗮𝗱𝗼 𝗽𝗼𝗿', '𝙏𝙞𝙡𝙞𝙣'].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
