...
lugar = official[0][0] == String(contact[0]) ? 'Goku' : official[1][0] == String(contact[0]) ? 'Sisked' : official[2][0] == String(contact[0]) ? 'Sisked' : official[3][0] == String(contact[0]) ? 'Goku' : country === '' ? lenguajeGB.smsContacto7() : country
enlace = official[0][0] == String(contact[0]) ? 'Goku' : official[1][0] == String(contact[0]) ? 'Sisked' : official[2][0] == String(contact[0]) ? 'Sisked' : official[3][0] == String(contact[0]) ? 'Goku' : md 
